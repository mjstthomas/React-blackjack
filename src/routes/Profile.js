    ...
    return (
      <div>
        <div className="goback">
          <button className="goBack-btn" onClick={this.handleClick}>
            Go Back
          </button>
        </div>
        <div className="profile-container">
          ...
          <p>
            player image: {user.user_image}{" "}
            <button className="stay-btn" onClick={this.handleChangeImage}>
              Change?
            </button>
          </p>
        </div>
