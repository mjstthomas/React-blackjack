      ...
      <div className="btn-container">
        {!this.props.gameStart && (
          <button
            ...
            type="button"
            onClick={this.props.deckShuffle}
          >
            New Game?
          </button>
        )}
        {this.props.gameStart && this.props.showDealerCard && (
          <button
            className="newHand-btn"
            type="button"
        ...
        {this.props.gameStart &&
          ...
          !this.props.showDealerCard && (
            <button className="deal-btn" type="button" onClick={this.handleHit}>
              Hit
            </button>
          )}
        {this.props.gameStart &&
