...
class PlayerContainer extends React.Component {
  ...
  render() {
    ...
    const healthBar = healthArray.map((item) => (
      <div key={i++} className="player-health"></div>
    ));
    return (
      <div className="Player-image-container">
        ...
        <Link to="/Profile">
          <img
            className={
              this.props.poweredUp === false
                ? this.props.playerHit
                  ? "player-image-hit"
                  : "player-image"
                : "player-image-powered"
            }
            src={
              this.props.poweredUp
                ? this.context.image.two
                : this.context.image.one
            }
